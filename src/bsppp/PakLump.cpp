...
PakLump::PakLump(const std::string& fullFilePath_)
		: ZIP(fullFilePath_)
...
bool PakLump::bake(const std::string& outputDir_, BakeOptions options, const EntryCallback& callback) {
